...
\begin{frame}
  \begin{center}
    \vfill\vfill
    \includegraphics[width=0.5\textwidth]{src/graphics/elegant-weapons.png}\\
    \vspace{2em}
    \fontsize{20pt}{20pt}{\textbf{Elegant Weapons for a More Civilized Page}}
    \vfill\vfill
  \end{center}
  \notelist{
  \item This was my original title, but I did not dare apply with it
    }
\end{frame}
...
\begin{frame}
  ...
  \item And usually, without Javascript execution, you get nothing
  \begin{itemize}
    \item Does this matter? Yes.
    \item Disabled, flaky network, low-budget devices
  \end{itemize}
  \item SPAs tends to reinvent things already present in web browers, like routing and forms
  }
\end{frame}
...
\begin{frame}
  ...
  \item Do they really needs Javascript to be able to work?
...
\begin{frame}
  ...
  \begin{itemize}
    \pause
    \item<+-> Mainstream languages in web server programming
  ...
  \end{itemize}
  \notelist{
  \item We have seen a lot of dynamically typed languages in web development, PHP, Ruby...
  \item Also the mainstream object-oriented like Java and C\#, perhaps with MVC frameworks
...
\begin{frame}
  ...
  \item And, if you're working with Clojure, you often get this ...
  }
\end{frame}

{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{src/graphics/npe.png}}
\begin{frame}[plain]
\end{frame}
}

\begin{frame}
  \singletitle{Let's use extensible records in PureScript!}
  \notelist{
...
\begin{frame}
  \singletitle{Summary}
  \notelist{
  \item Server-side or SPA is not a binary choice
