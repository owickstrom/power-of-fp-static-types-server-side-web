...
\begin{frame}
  ...
  \item Building Hyper in free time, central theme of this talk
  }
\end{frame}
...
\begin{frame}
  ...
  \item The first part is a general overview of ...
  \item I'll talk about server-side rendering
  \item and some nice examples of static typing for server-side web
...
\begin{frame}
  ...
  \item Then gradually make things nicer for more capable clients
	...
	\item Server-side rendering, for me, is also about leveraging the browser
	\item I want to mention the hype around \textit{isomorphic}
  \item Javascript app that runs on both backend and on clients, transparently
  \item Ends up being initial rendering
  \item The client and server state machines are fundamentally different
  \item A nice approach that we use for CodeScene is PJAX...
  \item There are benefits with server-side rendering.
  }
\end{frame}
...
\begin{frame}
  ...
  \item It is very easy to mess up. You can get...
